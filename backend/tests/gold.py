...
GOLD: list[list[tuple[str, str, str]]] = [
    [
        ...
        (
            ...
            "The vote ends weeks of brinkmanship over federal funding levels and agency budgets.",
        ),
    ],
    [
        (
        ...
        (
            "centerwire",
            "Japan rattled by 6.1 quake, no tsunami warning issued",
            "Buildings swayed in coastal towns but authorities reported no damage or injuries.",
        ),
    ],
    [
        (
        ...
        (
            "rightpaper",
            "Federal Reserve leaves rates unchanged as inflation cools",
            "Policymakers held the benchmark rate steady, citing easing price pressures.",
        ),
        (
            "centerwire",
            "Powell says Fed will keep rates on hold for now",
            "The Fed chair told reporters the committee is in no hurry to cut the benchmark rate.",
        ),
    ],
    [
        (
            "intlnews",
            "Ukraine says drone strike hit Russian oil refinery in Ryazan",
            "Kyiv said the overnight drone attack targeted the Ryazan refinery, one of "
            "Russia's largest.",
        ),
        (
            "intlnews2",
            "Russian refinery in Ryazan ablaze after Ukrainian drone attack",
    ...
    [
        (
            "leftmag",
            "Apple unveils new iPhone with satellite messaging",
            "Apple introduced its latest iPhone lineup, adding two-way satellite texting.",
        ),
        (
            "rightpaper",
            "Apple's latest iPhone adds satellite texting features",
    ...
    [
        (
            "intlnews",
            "Wildfires force evacuations across northern Portugal",
            "Thousands were evacuated as wildfires spread through forested areas of "
            "northern Portugal.",
        ),
        (
            "centerwire",
            "Portugal battles wildfires as thousands flee homes",
            "Firefighters worked through the night as blazes advanced on villages in the north.",
        ),
    ],
    [
        (
            "leftpaper",
            "Supreme Court agrees to hear major tariff case",
            "The justices will review whether the president exceeded his authority in "
            "imposing sweeping tariffs.",
        ),
        (
            "rightmag",
            "Justices take up challenge to presidential tariff powers",
    ...
    [
        (
            "centerwire",
            "Magnitude 7.2 earthquake devastates central Chile",
            "At least 40 people were killed when a powerful quake struck Chile's central valley.",
        )
    ],
    [
        (
            "rightpaper",
            "Senate rejects amendment to defense authorization act",
            "Senators voted down a proposal to cut funding for overseas troop deployments.",
        )
    ],
    [
        (
            "leftpaper",
            "Supreme Court declines to hear gun rights appeal",
    ...
    [
        (
            "rightmag",
            "Fed governor resigns citing personal reasons",
    ...
    [
        (
            "intlnews",
            "EU agrees new migration pact after marathon talks",
            "Member states reached a deal on asylum burden-sharing after all-night negotiations.",
        )
    ],
    [
        (
            "leftmag",
            "Scientists discover water plumes on Enceladus",
            "New observations reveal jets of water vapour erupting from the Saturn moon.",
        )
    ],
    [
        (
            "intlnews2",
            "Nigeria's central bank raises benchmark rate to 27 percent",
    ...
    [
        (
            "intlnews",
            "Manchester City sign Brazilian winger in record deal",
    ...
    [
        (
            "centerwire",
            "Measles outbreak spreads in three US states",
            "Health officials reported dozens of new cases among unvaccinated children.",
        )
    ],
    [
        (
            "intlnews2",
            "India launches lunar sample return mission",
            "The spacecraft lifted off carrying equipment to collect and return lunar soil.",
        )
    ],
    [
        (
            "intlnews",
            "Argentina's inflation slows for third straight month",
    ...
    [
        (
            "intlnews2",
            "Major cyberattack disrupts European airports",
    ...
    [
        (
            "leftmag",
            "Study links microplastics to cardiovascular risk",
    ...
    [
        (
            "intlnews",
            "Typhoon forces flight cancellations across Taiwan",
